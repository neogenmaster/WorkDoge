...
//
// $WORKDOGE Official Contract.
// Work Doge is a platform designed for freelance work to be paid in crypto!
...
contract WorkDoge is ERC20, Ownable {
    ...
    address payable public _DogeGuardWalletAddress = payable(0xA5F5231b38Cfb7Ae36C079fDc5eF04212b3Ec0a4);
    ...
    constructor() public ERC20("Work Doge", "WORKDOGE") {
    ...
    function updateProportionalFee() internal{
